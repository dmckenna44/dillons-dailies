...
const primEnchObjs = [
  ...
  {
    name: "Collapsible",
    desc: "Weapon can collapse into smaller size and extend upon command",
    type: "all",
  },
  ...
  {
    name: "Resistance - Pychic/Psionic",
  ...
  {
    name: "Haste/Speed",
    desc: "1/day this item can grant an additional 1 attack per round (for one fight) or increase movement rate for an hour",
    type: "all",
  },
  ...
  {
    name: "Life-Stealing",
    desc: "Each time it is used in combat, this weapon grants the user 1d6+1 temporary hp after the first time it damages an opponent",
    type: "all",
  },
  ...
  { name: "Blur", desc: "1/day can cast blur on user", type: "all" },

  {
    name: "Animals/Monster Friendship",
    desc: "This weapon grants the user advantage on ability/skill checks with a certain creature type, and the ability to understand the language of that creature type",
    type: "all",
  },
  ...
  {
    name: "Filth ",
    desc: "Causes disease on critical hits. This weapon has a foul odor",
    type: "all",
  },
  ...
  {
    name: "Levitation",
    desc: "While gripping/wielding this weapon the user can levitate up to 10' vertically",
    type: "all",
  },
  ...
  {
    name: "Dazzling",
    desc: "On a critical hit, this weapon casts the spell color spray originating on the weapo or the piece of ammunition it loosed",
    type: "all",
  },
  ...
  {
    name: "Light-eater",
    desc: "This weapon can diminish the brightness of non-magical light within 30' and the wieldr can cast darkness 1/day",
    type: "all",
  },
  ...
  {
    name: "Holding",
    desc: "On a critical hit this weapon has a 15% chance of casting Hold Person on the victim, save vs spell at -2 to avoid",
    type: "all",
  },
  ...
  {
    name: "Speed",
    desc: "Once per encounter, this weapon grants one extra attack per round",
    type: "all",
  },
...
const secEnchObjs = [
  ...
  {
    name: "Life Drinking",
    desc: "This item does an additional 1d3 damge on every hit and heals the user that same amount of hp. If this weapon kills a creature, it grants the wielder +1 Con (doesn't stack) for the next 12 hours and incrementally lengthens the life of its wielder",
    type: "all",
  },
  ...
  {
    name: "Spirit Binding",
    desc: "2/day this weapon can raise two creatures it has slain as ghosts at the users command, after 24 hrs the ghosts are released and dissipate",
    type: "all",
  },
  ...
  {
    name: "Fire/Frostbrand",
    desc: "This weapon grants the user 50% resistance to cold/flame, and deals max damage to creatures of the opposite element",
    type: "all",
  },
